...
const quickLinks: ILink[] = [
  { label: '家', href: '/' },
  { label: '產品', href: '/product/highlights' },
  { label: "服務", href: '/services' },
  { label: "現場支持", href: '/support/contact' },
  { label: "訂購演示", href: '/product/live-demo' },
]
    ...
    <div className='w-full bg-white py-6 xl:px-[12%] lg:px-[10%] md:px-[7%] sm:px-[5%] px-[3%]'>
      <div className='py-6 border-b border-[#D7D7D7] w-full grid grid-cols-2  lg:grid-cols-4 gap-6'>
        ...
        <div className='space-y-3'>
          <h2 className='capitalize font-medium sm:text-xl text-base text-grayish-100'>最新消息</h2>
